  ...
  <div>
    <div class="card-body">
      <div class="dataTables_wrapper dt-bootstrap4 no-footer">
        <v-server-table url="/api/equipment-type" :columns="columns" :options="options">
          ...
          <div class="" slot="action" slot-scope="props">
            <div class="dropdown dropdown-inline">
              ...
              <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                <ul class="navi flex-column navi-hover py-2">
                  ...
                  <li class="navi-item"><a href="#" class="navi-link"> <span class="navi-icon"><i
                      class="la la-print"></i></span> <span class="navi-text">Print</span> </a>
                  </li>
                  <li class="navi-item"><a href="#" class="navi-link"> <span class="navi-icon"><i
                      class="la la-copy"></i></span> <span class="navi-text">Copy</span> </a></li>
                  <li class="navi-item"><a href="#" class="navi-link"> <span class="navi-icon"><i
                      class="la la-file-excel-o"></i></span> <span class="navi-text">Excel</span>
                  </a>
                  </li>
                  <li class="navi-item"><a href="#" class="navi-link"> <span class="navi-icon"><i
                  ...
                  <li class="navi-item"><a href="#" class="navi-link"> <span class="navi-icon"><i
                      class="la la-file-pdf-o"></i></span> <span class="navi-text">PDF</span> </a>
                  </li>
                </ul>
              </div>
              ...
              <a href="javascript:;" class="btn btn-sm btn-clean btn-icon" :title="props.row.id"> <span
